...
const BUILT_IN_LESSONS = [
  ...
  // ── SESSION 5 ── Adjective agreement + negation
  {
    id: 9, session: 5, week: 5, month: "June", title: "Adjektive — Maskulin & Feminin", emoji: "🎨",
    grammarTip: {
  ...
  {
    id: 10, session: 5, week: 5, month: "June", title: "Verneinung: Je n'ai pas de…", emoji: "🚫",
    grammarTip: {
  ...
  {
    id: 11, session: 6, week: 6, month: "June", title: "Singulier & Pluriel", emoji: "1️⃣",
    grammarTip: {
  ...
  {
    id: 12, session: 6, week: 6, month: "June", title: "Mon, Ma, Mes — Mein/Meine", emoji: "👤",
    grammarTip: {
  ...
  {
    id: 13, session: 7, week: 7, month: "July", title: "Etre — sein (je suis, tu es...)", emoji: "🔵",
    grammarTip: {
  ...
  {
    id: 14, session: 7, week: 7, month: "July", title: "Etre — Adjektive & Verneinung", emoji: "🔵",
    grammarTip: {
  ...
  {
    id: 15, session: 8, week: 8, month: "July", title: "Avoir — haben (j'ai, tu as...)", emoji: "🟡",
    grammarTip: {
  ...
  {
    id: 16, session: 9, week: 9, month: "August", title: "Aller — gehen (je vais, tu vas...)", emoji: "🟢",
    grammarTip: {
  ...
  {
    id: 17, session: 9, week: 9, month: "August", title: "Aimer, Adorer, Detester", emoji: "❤️",
    grammarTip: {
  ...
  {
    id: 18, session: 10, week: 10, month: "August", title: "Liaisons — A E I O U", emoji: "🔗",
    grammarTip: {
...
const GRAMMAR_VAULT = [
  { id: 1, lessonId: 1, title: "Tu vs Vous", emoji: "👥", color: "#6366F1",
    ...
    table: { headers: ["Situation","Pronomen","Beispiel"], rows: [["Mit Freunden","tu","Ca va, tu ?"],["Formell","vous","Ca va, vous ?"],["Plural","vous","Comment allez-vous ?"]] },
    tip: "Benutze immer vous mit Lehrern und Fremden!" },
  { id: 2, lessonId: 2, title: "Zahlen 1–10", emoji: "🔢", color: "#FF6B35",
    explanation: "Die franzosischen Zahlen 1–10 muss man auswendig lernen.",
    table: { headers: ["Zahl","Französisch"], rows: [["1","un"],["2","deux"],["3","trois"],["4","quatre"],["5","cinq"],["6","six"],["7","sept"],["8","huit"],["9","neuf"],["10","dix"]] },
    tip: "Taglich laut zahlen — Wiederholung ist der Schlussel!" },
  { id: 3, lessonId: 3, title: "Zahlen 11–100", emoji: "💯", color: "#F59E0B",
    explanation: "Zahlen uber 20 werden kombiniert: 17 = dix-sept (zehn-sieben). 70 = soixante-dix (sechzig-zehn)!",
    table: { headers: ["Zahl","Französisch","Muster"], rows: [["11","onze","Sonderform"],["20","vingt","Basis"],["21","vingt et un","20+1"],["70","soixante-dix","60+10"],["100","cent","Basis"]] },
    tip: "70 = soixante-dix (60+10) — sehr ungewohnlich!" },
  { id: 4, lessonId: 4, title: "Maskulin & Feminin — un/une", emoji: "🏷️", color: "#4ECDC4",
    explanation: "Jedes franzosische Nomen ist entweder maskulin (un/le) oder feminin (une/la). Keine Regel — mit jedem Wort lernen!",
    table: { headers: ["Geschlecht","Artikel","Beispiel"], rows: [["Maskulin","un/le","un chat"],["Feminin","une/la","une gomme"],["Plural mask.","des/les","des chats"],["Plural fem.","des/les","des gommes"]] },
    tip: "Lerne immer Nomen MIT Artikel: un stylo, nicht nur stylo!" },
  { id: 5, lessonId: 5, title: "Farbadjektive nach dem Nomen", emoji: "🎨", color: "#A78BFA",
    explanation: "Im Franzosischen kommen Adjektive NACH dem Nomen. Maskulin: kein e → vert. Feminin: e am Ende → verte. rouge bleibt gleich!",
    table: { headers: ["Maskulin","Feminin","Bedeutung"], rows: [["vert","verte","grün"],["noir","noire","schwarz"],["bleu","bleue","blau"],["rouge","rouge","rot (gleich!)"],["blanc","blanche","weiß"]] },
    tip: "Nomen + Farbe: un stylo rouge, une pomme verte. Farbe IMMER nach dem Nomen!" },
  { id: 6, lessonId: 6, title: "Mon / Ma / Mes", emoji: "👤", color: "#22c55e",
    explanation: "Mon = mein (mask.), ma = meine (fem.), mes = meine (Plural). Vor Vokalen IMMER mon — auch bei Femininum!",
    table: { headers: ["Geschlecht","Possessiv","Beispiel"], rows: [["Maskulin","mon","mon frere"],["Feminin","ma","ma soeur"],["Plural","mes","mes parents"],["Feminin + Vokal","mon!","mon amie (nicht ma amie)"]] },
    tip: "Vor A E I O U immer mon — mon amie, mon ecole, mon orange!" },
  { id: 7, lessonId: 7, title: "J'aime / Je n'aime pas", emoji: "❤️", color: "#EF4444",
    explanation: "J'aime = Ich mag. Je n'aime pas = Ich mag nicht. Nach aimer immer les fur Plural!",
    table: { headers: ["Französisch","Deutsch","Beispiel"], rows: [["J'aime","Ich mag","J'aime les chats"],["Je n'aime pas","Ich mag nicht","Je n'aime pas les serpents"],["J'adore","Ich liebe","J'adore les chiens"],["Je deteste","Ich hasse","Je deteste les araignees"]] },
    tip: "Nach aimer/adorer/detester immer les: J'aime LES chats!" },
  { id: 8, lessonId: 8, title: "Du / De la / Des", emoji: "🍽️", color: "#D97706",
    explanation: "Der Teilungsartikel zeigt etwas von. Du (mask.), de la (fem.), des (Plural). Vor Vokal: de l'.",
    ...
    tip: "Nach Verneinung wird alles zu de: Je ne mange PAS DE pain" },
  { id: 9, lessonId: 9, title: "Adjektive — mask./fem.", emoji: "✏️", color: "#6366F1",
    explanation: "Maskulin = kein e am Ende. Feminin = e am Ende. Die Farbe steht NACH dem Nomen: Nomen + Couleur.",
    table: { headers: ["Maskulin","Feminin","Regel"], rows: [["vert","verte","+e"],["noir","noire","+e"],["bleu","bleue","+e"],["rouge","rouge","gleich!"],["blanc","blanche","Sonderform"]] },
    tip: "Merke: Nomen + Farbe. NICHT Farbe + Nomen wie im Deutschen!" },
  { id: 10, lessonId: 10, title: "Verneinung: ne ... pas", emoji: "🚫", color: "#EF4444",
    explanation: "Um nicht zu sagen: ne + Verb + pas. Vor Vokalen wird ne zu n'. Nach Je n'ai pas kommt de (nicht un/une).",
    table: { headers: ["Positiv","Negativ","Bedeutung"], rows: [["J'ai un stylo","Je n'ai pas de stylo","Ich habe keinen Stift"],["J'aime le lait","Je n'aime pas le lait","Ich mag Milch nicht"],["Il est grand","Il n'est pas grand","Er ist nicht groß"]] },
    tip: "AEIOU → n': j'ai, n'ai, n'est, n'aime — nie ne ai!" },
  { id: 11, lessonId: 11, title: "Singulier & Pluriel", emoji: "1️⃣", color: "#4ECDC4",
    explanation: "Plural = s am Ende (man hort es nicht!). Artikel: un/une → des, le/la → les.",
    table: { headers: ["Singular","Plural","Artikelaenderung"], rows: [["un chat","des chats","un → des"],["une pomme","des pommes","une → des"],["le livre","les livres","le → les"],["la gomme","les gommes","la → les"]] },
    tip: "Das s im Plural hoert man nicht — nur beim Lesen sehen!" },
  { id: 12, lessonId: 12, title: "Mon / Ma / Mes (Wiederholung)", emoji: "👨‍👩‍👧", color: "#22c55e",
    explanation: "Mon (mask.), ma (fem.), mes (Plural). Vor Vokalen immer mon — auch bei femininen Nomen!",
    table: { headers: ["Form","Verwendung","Beispiel"], rows: [["mon","Maskulin","mon pere, mon frere"],["ma","Feminin","ma mere, ma soeur"],["mes","Plural","mes parents, mes amis"],["mon!","Feminin + Vokal","mon amie, mon ecole"]] },
    tip: "Teste dich: mon/ma/mes devant: pere, mere, amie, ecole, parents, freres" },
  { id: 13, lessonId: 13, title: "ETRE — sein", emoji: "🔵", color: "#3B82F6",
    explanation: "Etre (sein) ist das wichtigste und unregelmaßigste Verb auf Franzosisch. Alle Formen auswendig lernen!",
    table: { headers: ["Person","etre","Deutsch"], rows: [["je","suis","ich bin"],["tu","es","du bist"],["il/elle","est","er/sie ist"],["nous","sommes","wir sind"],["vous","etes","ihr seid"],["ils/elles","sont","sie sind"]] },
    tip: "ETRE + Adjektiv: Adjektiv stimmt mit Nomen uberein! Il est grand / Elle est grande." },
  { id: 14, lessonId: 14, title: "ETRE + Adjektiv", emoji: "💬", color: "#6366F1",
    explanation: "ETRE + Adjektiv beschreibt wie jemand ist. Maskulin: kein e. Feminin: e am Ende. Verneinung: Il n'est pas grand.",
    table: { headers: ["Maskulin","Feminin","Deutsch"], rows: [["grand","grande","groß"],["petit","petite","klein"],["content","contente","gluecklich"],["fatigue","fatiguee","muede"],["sympa","sympa","nett (gleich!)"],["triste","triste","traurig (gleich!)"]] },
    tip: "sympa und triste andern sich nicht! Beide Formen sind gleich." },
  { id: 15, lessonId: 15, title: "AVOIR — haben", emoji: "🟡", color: "#EAB308",
    explanation: "Avoir (haben) ist das zweithaufigste Verb. Fur Alter: J'ai neuf ans (nicht je suis!).",
    table: { headers: ["Person","avoir","Deutsch"], rows: [["j'","ai","ich habe"],["tu","as","du hast"],["il/elle","a","er/sie hat"],["nous","avons","wir haben"],["vous","avez","ihr habt"],["ils/elles","ont","sie haben"]] },
    tip: "Alter mit AVOIR: J'ai neuf ans. NICHT je suis neuf ans!" },
  { id: 16, lessonId: 16, title: "ALLER — gehen", emoji: "🟢", color: "#16A34A",
    explanation: "Aller (gehen) ist unregelmaßig. Superpower: aller + Infinitiv = nahe Zukunft (wie going to auf Englisch).",
    table: { headers: ["Person","aller","Deutsch"], rows: [["je","vais","ich gehe"],["tu","vas","du gehst"],["il/elle","va","er/sie geht"],["nous","allons","wir gehen"],["vous","allez","ihr geht"],["ils/elles","vont","sie gehen"]] },
    tip: "Je vais manger = Ich werde essen. Aller + Infinitiv = Zukunft!" },
  { id: 17, lessonId: 17, title: "Aimer / Adorer / Detester", emoji: "❤️", color: "#EC4899",
    explanation: "Aimer (mogen), adorer (lieben), detester (hassen) — regelmaßige Verben. Nach diesen Verben: les fur Plural!",
    table: { headers: ["Person","aimer","Deutsch"], rows: [["j'","aime","ich mag"],["tu","aimes","du magst"],["il/elle","aime","er/sie mag"],["nous","aimons","wir mogen"],["vous","aimez","ihr mogt"],["ils/elles","aiment","sie mogen"]] },
    tip: "J'aime LES chats. J'adore LES chiens. Immer les nach diesen Verben!" },
  { id: 18, lessonId: 18, title: "Liaisons — A E I O U", emoji: "🔗", color: "#8B5CF6",
...
const MONTH_META = {
  ...
  June:   { label: "☀️ Juni — Grammatik & Verben", color: "#F59E0B" },
  July:   { label: "🎓 Juli — Etre, Avoir, Aller", color: "#6366F1" },
  August: { label: "🏆 August — Aimer & Liaisons", color: "#EC4899" },
};
